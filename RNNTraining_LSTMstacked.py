...
if __name__ =='__main__':
    ...
    for time in times:
        ...
        model = Sequential()
        if all_x.shape[1] == 7:
            model.add(LSTM(units=256, input_shape=(look_back_seq,7),return_sequences=True)) # 以及输入维度是 x,y coordinates and depth,四元数
        ...
        testMAPE = mean_absolute_percentage_error(test_label, testPredict)
